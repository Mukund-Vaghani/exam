    ...
    var template = `
		<html>
			...
			<body>
				...
				<center><a href='http://localhost:8191/api/v1/auth/resetform/${result[0].id}' style="padding:10px;background-color:skyblue;color:white">Password Reset</a></center><br>
